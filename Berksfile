...
cookbook 'opsworks_elasticsearch', '~> 0.2.0', git: 'git://github.com/briankmove/chef-opsworks-elasticsearch.git'
cookbook 'opsworks_kibana', '~> 0.2.1', git: 'git://github.com/briankmove/chef-opsworks-kibana.git'
